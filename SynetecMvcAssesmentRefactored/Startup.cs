...
using SynetecMvcAssesmentRefactored.Repository;
using SynetecMvcAssessmentRefactored.IServices;
using SynetecMvcAssessmentRefactored.Services;

namespace SynetecMvcAssesmentRefactored
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Repositories
            services.AddScoped<IHrDepartmentRepository, HrDepartmentRepository>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                    name: "default",
                    pattern: "{controller=Bonus}/{action=Index}/{id?}");
            });
        }
    }
}
